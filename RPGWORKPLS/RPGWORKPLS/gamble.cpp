...
treeLoss* createLossNode(int money);
treeWin* createWinNode(int money);
treeLoss* insertLossNode(treeLoss* root, int money);
treeWin* insertWinNode(treeWin* root, int money);
